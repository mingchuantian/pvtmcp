...
from mcp import MarginCosineProduct
...
def get_args_parser():
    ...
    # * Mixup params
    parser.add_argument('--mixenable',action='store_true', default=False)
    ...
    parser.add_argument('--data-path', default='/datasets01/imagenet_full_size/061417/', type=str,
                        help='dataset path')
    parser.add_argument('--data_set', default='CASIA', choices=['CIFAR', 'IMNET', 'INAT', 'INAT19','CASIA'],
    ...
    parser.add_argument('--start_epoch', default=0, type=int, metavar='N',
                        help='start epoch')
    parser.add_argument('--cos_margin',action='store_true',help='Perform evaluation only')
...
def main(args):
    ...
    """
    loss_scaler = NativeScaler()
    optimizer=torch.optim.SGD(model_without_ddp.parameters(),lr=0.1,momentum=0.9,weight_decay=0.0005)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        adjust_learning_rate(optimizer, epoch*100,[15000, 22000, 26000])
        ...
        test_stats = evaluate(data_loader_val, model, device,mcp=args.cos_margin)
